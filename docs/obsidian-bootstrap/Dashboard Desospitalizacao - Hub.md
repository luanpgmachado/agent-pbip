...
- Specs ativas: [docs/specs/](../specs/)
- Plans ativos: [docs/plans/](../plans/)
- Schema/linhagem: [docs/References/notebook/NOTEBOK.md](../References/notebook/NOTEBOK.md)
- Cards/medidas: [docs/GUIA_MEDIDAS_DASHBOARD_V2.md](../GUIA_MEDIDAS_DASHBOARD_V2.md)
- Contrato HTML/payload: [docs/specs/dashboard_tecnico_manutencao.md](../specs/dashboard_tecnico_manutencao.md)

## Estrutura do vault

- [[00-Inbox/]]: demandas brutas, ideias e notas de reuniao ainda sem execucao.
- [[01-Decisoes/]]: ADRs curtas e decisoes humanas.
- [[02-Specs/]]: mapas/resumos de specs, sempre linkando arquivo em `docs/specs/`.
- [[03-Plans/]]: mapas/resumos de plans, sempre linkando arquivo em `docs/plans/`.
- [[04-Releases/]]: resumo humano de entregas fechadas.
- [[05-Reunioes/]]: atas e encaminhamentos.
- [[06-Glossario/]]: termos de negocio e semantica.
- [[99-Archive/]]: notas antigas ou contexto substituido.
